...
class HomeScreen extends StatefulWidget {
  ...
  const HomeScreen({Key? key, this.id, this.nama}) : super(key: key);
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<List<ProductModel>> fetchProductData() async {
    final dio = Dio();
    const String url = "${MyColors.baseUrl}/api/products";
  ...
  Future deleteProduct(
    ...
    try {
      final response = await dio.delete("${MyColors.baseUrl}/api/products/$productId",
          data: data,
                                ...
                                GestureDetector(
                                  onTap: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => AddProductScreen(id: widget.id, nama: widget.nama),
                                      ),
                                    );
                                  },
                    ...
                    child: FutureBuilder<List<ProductModel>>(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState == ConnectionState.waiting) {
                          ...
                          return const Center(child: Text('No products available.', style: TextStyle(color: MyColors.whiteColor)));
                        } else {
                                  ...
                                  child: ListTile(
                                    ...
                                    subtitle: Column(
                                      ...
                                      children: [
                                        ...
                                        Text('Tanggal Dibuat : '+(product.createdAt ?? '').toString(), style: TextStyle(color: MyColors.whiteColor))
                                      ],
                                    ),
                                    trailing: Row(
                                        ...
                                        IconButton(
                                          ...
                                          onPressed: () {
                                            Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                builder: (context) => EditProductScreen(id: product.id),
                                              ),
                                            );
                                          },
                                        ),
